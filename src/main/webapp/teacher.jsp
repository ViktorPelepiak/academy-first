...
<html>
<head>
    <title>Розклоад для викладачів</title>
                ...
                <form method="post" id="test" action="/ViPSchedule/for_teacher">
                    <select class="form-control" style="width: 300px" size="1" name="teacherId"
                        ...
                        <c:forEach var="t" items="${teachers}">
                            <option value="${t.id}" <c:if test="${t.id==teacherId}">selected</c:if>>${t.firstName} ${t.fatherName} ${t.lastName}</option>
                        </c:forEach>
                    </select></form>
            </li>
        </ul>
